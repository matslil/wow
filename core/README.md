...
These rules define methodology conformance and cannot be tailored:
...
- all AI interaction is crisp, structured, condensed, and ordered by importance;
- each project completes its own mandatory project definition;
